    ...
    return (
        <section className={styles.container}>
            <div className={`content ${styles.content}`}>
                ...
                <svg data-aos="fade-up" data-aos-delay={150*1} width="125" height="125" viewBox="0 0 350 350" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p data-aos="fade-up" data-aos-delay={150*2}>{texts.subtitle1}</p>
            </div>
        </section>
    )
}
